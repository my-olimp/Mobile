...
import ramble.sokol.myolimp.feature_calendar.presentation.components.feature_clock.Mark
...
fun ClockMarks24h(
    ...
    if (selectedPart == TimePart.StartHour || selectedPart == TimePart.EndHour) {
        ...
        Mark(text = "02", index = 2, isSelected = selectedTime == 2, onIndex = onTime)
        Mark(text = "03", index = 3, isSelected = selectedTime == 3, onIndex = onTime)
        Mark(text = "04", index = 4, isSelected = selectedTime == 4, onIndex = onTime)
        Mark(text = "05", index = 5, isSelected = selectedTime == 5, onIndex = onTime)
        Mark(text = "06", index = 6, isSelected = selectedTime == 6, onIndex = onTime)
        Mark(text = "07", index = 7, isSelected = selectedTime == 7, onIndex = onTime)
        Mark(text = "08", index = 8, isSelected = selectedTime == 8, onIndex = onTime)
        Mark(text = "09", index = 9, isSelected = selectedTime == 9, onIndex = onTime)
